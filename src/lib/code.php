...
class code
{
    ...
    private $getCode3Url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=%s&redirect_uri=%s&response_type=%s&scope=%s&state=%s&component_appid=%s#wechat_redirect";
     ...
     * @return string
     */
    public function getCode3Url($app_id, $redirect_uri, $component_appid, $response_type = "code", $scope = "snsapi_userinfo", $state = "")
    {
        return sprintf($this->getCode3Url, $app_id, $redirect_uri, $response_type, $scope, $state, $component_appid);
    }
